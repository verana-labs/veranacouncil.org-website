...
export const metadata: Metadata = {
  title: "Cookies",
  description:
    "How veranacouncil.org uses cookies: essential only by default, consent-gated analytics, no ad networks or cross-site trackers.",
};
      ...
      <article className="prose-body max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <ul>
          ...
          <li>
            ...
            (<code>vc-theme</code>) and dismissed announcement are likewise stored
        ...
        <p>
          Clear site data for veranacouncil.org in your browser to reset the
