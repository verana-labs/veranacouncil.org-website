...
const TOPICS = [
  { value: "council-founding-member", label: "Council membership — Founding Member" },
  { value: "council-observer", label: "Council membership — Observer" },
  { value: "ecs-participant", label: "ECS participant — expression of interest" },
  { value: "governance", label: "Governance / frameworks" },
