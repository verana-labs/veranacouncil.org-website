 ...
 * wordmark — "Verana" in ink, "Council" in Verana purple — like the site.
 */
function logo(): string {
  const url = process.env.EMAIL_LOGO_URL;
  if (url) {
    return `<img src="${url}" alt="Verana Council" height="28" style="display:block;border:0;outline:none;text-decoration:none;height:28px;">`;
  }
  return `<span style="font-family:${FONT};font-size:20px;font-weight:700;color:${INK};letter-spacing:-0.01em;">Verana<span style="color:${PURPLE};">Council</span></span>`;
}
    ...
    <tr><td align="center">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr><td style="padding:18px 28px;border-top:1px solid ${RULE};font-family:${FONT};font-size:12px;line-height:1.5;color:${MUTED};">
          Verana Council Association (in formation), stewarded by 2060 OÜ.<br>
          <a href="${SITE_URL}" style="color:${PURPLE};text-decoration:none;">veranacouncil.org</a>
        </td></tr>
      </table>
    </td></tr>
  </table>
