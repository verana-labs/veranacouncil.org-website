...
export async function sendAddedToOrgEmail(args: {
  ...
  await sendEmail({
    to: args.to,
    subject: `You've been added to ${args.orgName} on veranacouncil.org`,
    html: emailLayout({
      ...
      bodyHtml: `
        ...
        on the Verana Council site. As ${args.role === "manager" ? "an administrator you can manage the organization's profile, access list and candidacy, and" : "a representative you"} can take part in the Council bodies the membership grants.</p>
        ${access}
