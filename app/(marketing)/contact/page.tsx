...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Contact the Verana Council through one internally-routed form. We do not publish email addresses. Inquiry types: Council membership, ECS participants, governance, press, general.",
};
          ...
          <div className="grid md:grid-cols-12 gap-10">
            <aside className="md:col-span-4 order-2 md:order-1">
              ...
              <ul className="mt-6 space-y-4 text-sm text-muted">
                ...
                <li>
                  Submissions are confidential while the Council is in
                  formation.
                </li>
              </ul>
          ...
          <div className="md:col-span-8">
            <address className="not-italic text-muted leading-relaxed">
              <strong className="text-ink block text-lg">
                Verana Council Association (in formation)
              </strong>
