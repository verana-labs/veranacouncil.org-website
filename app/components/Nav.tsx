...
const ANNOUNCEMENT_KEY = "vc-announcement-dismissed";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {menuOpen && (
            <div id="mobile-menu" className="md:hidden pb-4 space-y-2">
              ...
              <Link href="/contact" className="block py-2 nav-link">
                Contact
              </Link>
              <Link
                href="/join"
                className="block py-2 nav-link font-medium text-indigo-primary"
              >
                Join →
              </Link>
            </div>
