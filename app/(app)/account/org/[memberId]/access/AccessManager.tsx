  ...
  return (
    <div className="grid gap-8">
      <section>
        ...
        {state.ok && <p className="text-sm text-indigo mt-2">Added.</p>}
                  ...
                  <tr key={e.id} className="border-t border-rule">
                    ...
                    <td className="p-2">
                      <form action={changeRole}>
                        ...
                        <button
                          type="submit"
                          className="text-indigo hover:underline disabled:text-muted disabled:no-underline disabled:cursor-not-allowed"
                          disabled={locked}
                        >
                          {counterLabel}
                        </button>
